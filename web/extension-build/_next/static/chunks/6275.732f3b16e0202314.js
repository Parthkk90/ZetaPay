(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[6275],{

/***/ 13254:
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {


const canPromise = __webpack_require__(15651)

const QRCode = __webpack_require__(41147)
const CanvasRenderer = __webpack_require__(7896)
const SvgRenderer = __webpack_require__(78011)
...
const getSymbolSize = (__webpack_require__(10172).getSymbolSize)
...
const Mode = __webpack_require__(65342)
...
const encodeUtf8 = __webpack_require__(8878)
const Mode = __webpack_require__(65342)
...
const ECLevel = __webpack_require__(65926)
...
const Utils = __webpack_require__(10172)
...
const VersionCheck = __webpack_require__(1691)
const Regex = __webpack_require__(44891)
...
const GF = __webpack_require__(16137)
...
const Utils = __webpack_require__(10172)
const ECLevel = __webpack_require__(65926)
const BitBuffer = __webpack_require__(81972)
const BitMatrix = __webpack_require__(17411)
const AlignmentPattern = __webpack_require__(19641)
const FinderPattern = __webpack_require__(99121)
const MaskPattern = __webpack_require__(69818)
const ECCode = __webpack_require__(16037)
const ReedSolomonEncoder = __webpack_require__(98490)
const Version = __webpack_require__(45057)
const FormatInfo = __webpack_require__(42936)
const Mode = __webpack_require__(65342)
const Segments = __webpack_require__(57711)
...
const Polynomial = __webpack_require__(86901)
...
const Mode = __webpack_require__(65342)
const NumericData = __webpack_require__(79964)
const AlphanumericData = __webpack_require__(33171)
const ByteData = __webpack_require__(20636)
const KanjiData = __webpack_require__(32269)
const Regex = __webpack_require__(44891)
const Utils = __webpack_require__(10172)
const dijkstra = __webpack_require__(46946)
...
const Utils = __webpack_require__(88834)
...
__webpack_require__.d(__webpack_exports__, {
  WcmModal: function() { return /* binding */ WcmModal; },
  WcmQrCode: function() { return /* binding */ WcmQrCode; }
});
...
var dist = __webpack_require__(57837);
...
var browser = __webpack_require__(13254);
...
function themeModeVariables() {
  var _a;
  const themeMode = (_a = dist.ThemeCtrl.state.themeMode) != null ? _a : "dark";
...
const ThemeUtil = {
  ...
  setTheme() {
    ...
    const { themeVariables } = dist.ThemeCtrl.state;
    if (root) {
...
let WcmModalBackcard = class extends lit_element_s {
  // -- render ------------------------------------------------------- //
  render() {
    return x`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${SvgUtil.WALLET_CONNECT_LOGO} <button @click="${dist/* ModalCtrl */.jb.close}">${SvgUtil.CROSS_ICON}</button></div>`;
  }
};
...
let WcmModalHeader = class extends lit_element_s {
  ...
  // -- private ------------------------------------------------------ //
  backBtnTemplate() {
    return x`<button class="wcm-back-btn" @click="${dist/* RouterCtrl */.AV.goBack}">${SvgUtil.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
  ...
  render() {
    ...
    const backBtn = dist/* RouterCtrl */.AV.state.history.length > 1;
...
const UiUtil = {
  ...
  getWalletIcon({ id, image_id }) {
    const { walletImages } = dist.ConfigCtrl.state;
    if (walletImages == null ? void 0 : walletImages[id]) {
      return walletImages[id];
    } else if (image_id) {
      return dist.ExplorerCtrl.getWalletImageUrl(image_id);
    }
    return "";
  },
  ...
  async preloadImage(src) {
    ...
    return Promise.race([imagePromise, dist/* CoreUtil */.zv.wait(3e3)]);
  },
  getErrorMessage(err) {
  ...
  handleMobileLinking(wallet, target = "_self") {
    const { walletConnectUri } = dist.OptionsCtrl.state;
    ...
    function onRedirect(uri) {
      if (nativeUrl) {
        const href = dist/* CoreUtil */.zv.formatNativeUrl(nativeUrl, uri, name);
        dist/* CoreUtil */.zv.openHref(href, target);
      } else if (universalUrl) {
        const href = dist/* CoreUtil */.zv.formatUniversalUrl(universalUrl, uri, name);
        dist/* CoreUtil */.zv.openHref(href, target);
      }
    }
    if (walletConnectUri) {
  ...
  handleAndroidLinking() {
    const { walletConnectUri } = dist.OptionsCtrl.state;
    if (walletConnectUri) {
      dist/* CoreUtil */.zv.setWalletConnectAndroidDeepLink(walletConnectUri);
      dist/* CoreUtil */.zv.openHref(walletConnectUri, dist/* CoreUtil */.zv.isTelegram() ? "_blank" : "_self");
    }
  },
  async handleUriCopy() {
    const { walletConnectUri } = dist.OptionsCtrl.state;
    if (walletConnectUri) {
      try {
        ...
        dist.ToastCtrl.openToast("Link copied", "success");
      } catch (e) {
        dist.ToastCtrl.openToast("Failed to copy", "error");
      }
    }
  },
  getCustomImageUrls() {
  ...
  openWalletExplorerUrl() {
    dist/* CoreUtil */.zv.openHref(UiUtil.EXPLORER_WALLET_URL, "_blank");
  },
  getCachedRouterWalletPlatforms() {
    const { desktop, mobile } = dist/* CoreUtil */.zv.getWalletRouterData();
  ...
  goToConnectingView(wallet) {
    dist/* RouterCtrl */.AV.setData({ Wallet: wallet });
    const isMobileDevice = dist/* CoreUtil */.zv.isMobile();
    const { isDesktop, isWeb, isMobile } = UiUtil.getCachedRouterWalletPlatforms();
    if (isMobileDevice) {
      if (isMobile) {
        dist/* RouterCtrl */.AV.push("MobileConnecting");
        if (!dist/* CoreUtil */.zv.isAndroid() && dist/* CoreUtil */.zv.isTelegram()) {
          this.handleMobileLinking(wallet, "_blank");
        }
      } else if (isWeb) {
        dist/* RouterCtrl */.AV.push("WebConnecting");
      } else {
        dist/* RouterCtrl */.AV.push("InstallWallet");
      }
    } else if (isDesktop) {
      dist/* RouterCtrl */.AV.push("DesktopConnecting");
    } else if (isWeb) {
      dist/* RouterCtrl */.AV.push("WebConnecting");
    } else if (isMobile) {
      dist/* RouterCtrl */.AV.push("MobileQrcodeConnecting");
    } else {
      dist/* RouterCtrl */.AV.push("InstallWallet");
    }
  }
...
let WcmModalRouter = class extends lit_element_s {
  ...
  constructor() {
    super();
    this.view = dist/* RouterCtrl */.AV.state.view;
    this.prevView = dist/* RouterCtrl */.AV.state.view;
    // -- private ------------------------------------------------------ //
    this.unsubscribe = void 0;
    this.oldHeight = "0px";
    this.resizeObserver = void 0;
    this.unsubscribe = dist/* RouterCtrl */.AV.subscribe((routerState) => {
...
let WcmModalToast = class extends lit_element_s {
  constructor() {
    ...
    this.unsubscribe = void 0;
    this.timeout = void 0;
    this.unsubscribe = dist.ToastCtrl.subscribe((newState) => {
      if (newState.open) {
        this.open = true;
        this.timeout = setTimeout(() => dist.ToastCtrl.closeToast(), 2200);
      } else {
        this.open = false;
  ...
  disconnectedCallback() {
    ...
    (_a = this.unsubscribe) == null ? void 0 : _a.call(this);
    clearTimeout(this.timeout);
    dist.ToastCtrl.closeToast();
  }
  // -- render ------------------------------------------------------- //
  render() {
    const { message, variant } = dist.ToastCtrl.state;
    const classes = {
...
let WcmQrCode = class extends lit_element_s {
  ...
  // -- private ------------------------------------------------------ //
  svgTemplate() {
    const isLightMode = dist.ThemeCtrl.state.themeMode === "light";
  ...
  render() {
    const classes = {
      "wcm-dark": dist.ThemeCtrl.state.themeMode === "dark"
    };
...
let WcmWalletButton = class extends lit_element_s {
  ...
  handleClick() {
    dist/* EventsCtrl */.uA.click({ name: "WALLET_BUTTON", walletId: this.walletId });
    this.onClick();
  }
  // -- render ------------------------------------------------------- //
  render() {
...
let WcmExplorerContext = class extends lit_element_s {
  ...
  async preloadListings() {
    if (dist.ConfigCtrl.state.enableExplorer) {
      await dist.ExplorerCtrl.getRecomendedWallets();
      dist.OptionsCtrl.setIsDataLoaded(true);
      const { recomendedWallets } = dist.ExplorerCtrl.state;
  ...
  async preloadData() {
    try {
      ...
      console.error(err);
      dist.ToastCtrl.openToast("Failed preloading", "error");
    }
  }
};
__decorateClass$i([
...
let WcmThemeContext = class extends lit_element_s {
  ...
  constructor() {
    ...
    ThemeUtil.setTheme();
    this.unsubscribeTheme = dist.ThemeCtrl.subscribe(ThemeUtil.setTheme);
  }
  disconnectedCallback() {
    var _a;
...
let WcmAndroidWalletSelection = class extends lit_element_s {
  // -- private ------------------------------------------------------ //
  onGoToQrcode() {
    dist/* RouterCtrl */.AV.push("Qrcode");
  }
  // -- render ------------------------------------------------------- //
  render() {
    const { recomendedWallets } = dist.ExplorerCtrl.state;
    const wallets = [...recomendedWallets, ...recomendedWallets];
    const recomendedCount = dist/* CoreUtil */.zv.RECOMMENDED_WALLET_AMOUNT * 2;
...
let WcmConnectorWaiting = class extends lit_element_s {
  ...
  svgLoaderTemplate() {
    ...
    const DH_ARRAY = 317;
    const DH_OFFSET = 425;
    const radius = (_b = (_a = dist.ThemeCtrl.state.themeVariables) == null ? void 0 : _a["--wcm-wallet-icon-large-border-radius"]) != null ? _b : ThemeUtil.getPreset("--wcm-wallet-icon-large-border-radius");
    let numRadius = 0;
    if (radius.includes("%")) {
...
const DataUtil = {
  manualWallets() {
    var _a, _b;
    const { mobileWallets, desktopWallets } = dist.ConfigCtrl.state;
    const recentWalletId = (_a = DataUtil.recentWallet()) == null ? void 0 : _a.id;
    const platformWallets = dist/* CoreUtil */.zv.isMobile() ? mobileWallets : desktopWallets;
    const wallets = platformWallets == null ? void 0 : platformWallets.filter((wallet) => recentWalletId !== wallet.id);
    return (_b = dist/* CoreUtil */.zv.isMobile() ? wallets == null ? void 0 : wallets.map(({ id, name, links }) => ({ id, name, mobile: links, links })) : wallets == null ? void 0 : wallets.map(({ id, name, links }) => ({ id, name, desktop: links, links }))) != null ? _b : [];
  },
  recentWallet() {
...
let WcmDesktopWalletSelection = class extends lit_element_s {
  // -- render ------------------------------------------------------- //
  render() {
    const { explorerExcludedWalletIds, enableExplorer } = dist.ConfigCtrl.state;
...
let WcmLegalNotice = class extends lit_element_s {
  // -- render ------------------------------------------------------- //
  render() {
    const { termsOfServiceUrl, privacyPolicyUrl } = dist.ConfigCtrl.state;
...
let WcmModal = class extends lit_element_s {
  ...
  constructor() {
    ...
    this.unsubscribeModal = dist/* ModalCtrl */.jb.subscribe((modalState) => {
      if (modalState.open) {
...
let WcmPlatformSelection = class extends lit_element_s {
  ...
  // -- private ------------------------------------------------------ //
  onMobile() {
    const isMobile = dist/* CoreUtil */.zv.isMobile();
    if (isMobile) {
      dist/* RouterCtrl */.AV.replace("MobileConnecting");
    } else {
      dist/* RouterCtrl */.AV.replace("MobileQrcodeConnecting");
    }
  }
  onDesktop() {
    dist/* RouterCtrl */.AV.replace("DesktopConnecting");
  }
  onWeb() {
    dist/* RouterCtrl */.AV.replace("WebConnecting");
  }
  // -- render ------------------------------------------------------- //
  render() {
...
let WcmViewAllWalletsButton = class extends lit_element_s {
  // -- render ------------------------------------------------------- //
  onClick() {
    dist/* RouterCtrl */.AV.push("WalletExplorer");
  }
  // -- render ------------------------------------------------------- //
  render() {
    const { recomendedWallets } = dist.ExplorerCtrl.state;
...
let WcmDesktopConnectingView = class extends lit_element_s {
  ...
  onFormatAndRedirect(uri) {
    const { desktop, name } = dist/* CoreUtil */.zv.getWalletRouterData();
    const nativeUrl = desktop == null ? void 0 : desktop.native;
    const universalUrl = desktop == null ? void 0 : desktop.universal;
    if (nativeUrl) {
      const href = dist/* CoreUtil */.zv.formatNativeUrl(nativeUrl, uri, name);
      dist/* CoreUtil */.zv.openHref(href, "_self");
    } else if (universalUrl) {
      const href = dist/* CoreUtil */.zv.formatUniversalUrl(universalUrl, uri, name);
      dist/* CoreUtil */.zv.openHref(href, "_blank");
    }
  }
  openDesktopApp() {
    const { walletConnectUri } = dist.OptionsCtrl.state;
    const routerData = dist/* CoreUtil */.zv.getWalletRouterData();
  ...
  // -- render ------------------------------------------------------- //
  render() {
    const { name, id, image_id } = dist/* CoreUtil */.zv.getWalletRouterData();
...
let WcmInstallWalletView = class extends lit_element_s {
  ...
  onInstall(uri) {
    if (uri) {
      dist/* CoreUtil */.zv.openHref(uri, "_blank");
    }
  }
  // -- render ------------------------------------------------------- //
  render() {
    const { name, id, image_id, homepage } = dist/* CoreUtil */.zv.getWalletRouterData();
...
let WcmMobileConnectingView = class extends lit_element_s {
  ...
  onFormatAndRedirect(uri, forceUniversalUrl = false) {
    const { mobile, name } = dist/* CoreUtil */.zv.getWalletRouterData();
    const nativeUrl = mobile == null ? void 0 : mobile.native;
    const universalUrl = mobile == null ? void 0 : mobile.universal;
    const target = dist/* CoreUtil */.zv.isTelegram() ? "_blank" : "_self";
    uri = dist/* CoreUtil */.zv.isTelegram() && dist/* CoreUtil */.zv.isAndroid() ? encodeURIComponent(uri) : uri;
  ...
  onGoToAppStore(downloadUrl) {
    if (downloadUrl) {
      dist/* CoreUtil */.zv.openHref(downloadUrl, "_blank");
    }
  }
  // -- render ------------------------------------------------------- //
  render() {
    const { name, id, image_id, app, mobile } = dist/* CoreUtil */.zv.getWalletRouterData();
...
let WcmWalletExplorerView = class extends lit_element_s {
  constructor() {
    super(...arguments);
    this.loading = !dist.ExplorerCtrl.state.wallets.listings.length;
    this.firstFetch = !dist.ExplorerCtrl.state.wallets.listings.length;
    this.search = "";
  ...
  isLastPage() {
    const { wallets, search } = dist.ExplorerCtrl.state;
  ...
  async fetchWallets() {
    ...
    if (!this.endReached && (this.firstFetch || total > PAGE_ENTRIES && listings.length < total)) {
      try {
        this.loading = true;
        const chains = (_a = dist.OptionsCtrl.state.chains) == null ? void 0 : _a.join(",");
        const { listings: newListings } = await dist.ExplorerCtrl.getWallets({
        ...
        await Promise.all([
          ...
          dist/* CoreUtil */.zv.wait(300)
        ]);
        this.endReached = this.isLastPage();
      } catch (err) {
        console.error(err);
        dist.ToastCtrl.openToast(UiUtil.getErrorMessage(err), "error");
      } finally {
        this.loading = false;
...
let WcmWebConnectingView = class extends lit_element_s {
  ...
  render() {
    ...
    const isMobilePlatform = dist/* CoreUtil */.zv.isMobile();
